...
import { GuestRequestDTO } from "../dto/GuestDTO";
import type { ReservationStatus, PaymentStatus } from "../entities/Reservation";

export interface IReservationService {
  // Crear una reserva nueva.
  createReservation(reservationDTO: ReservationDTO, guestDTO: GuestRequestDTO, userId: number, propertyId: number): Promise<{ msg: string }>;
